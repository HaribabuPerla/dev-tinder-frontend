...
function ProfileEdit({user}) {
  ...
  return (
    <>
  <div className="flex justify-center items-center p-10 md:m-10 mb-10 gap-6">
  <div className="card bg-gray-900 w-85 shadow-sm md:mx-4">
    <div className="card-body">
      ...
      <input
        ...
        className="input text-amber-100 bg-gray-900 input-success my-3"
      ...
      <div className="dropdown my-3">
        <div
          tabIndex={0}
          role="button"
          className="btn m-1 w-70 bg-gray-900 input-success text-amber-100 border-1 border-green-300 justify-start"
        >
          {inputData?.gender}
        </div>
        <ul
          ...
          tabIndex={0}
          className="dropdown-content menu bg-gray-900 border-1 text-white rounded-box z-1 w-52 p-2"
        >
      ...
      <div className="card-actions justify-center">
        <button
          ...
          className="btn w-80 btn-warning"
        >
          Save
        </button>
      </div>
